...
public class LocalStack extends Stack {
    ...
    public LocalStack(final App scope, final String id, final StackProps props) {
        ...
        CfnHealthCheck authDbHeathCheck =
                createDBHealthCheck(authServiceDb, "AuthServiceDBHealthCheck");
        CfnHealthCheck patientDbHeathCheck =
        ...
        FargateService authService =
                createFargateService(
                        ...
                        List.of(4005),
                        authServiceDb,
                        Map.of("JWT_SECRET", "gN/+4OoUmDMlmsHaIK3nH2xrKIl+ewatzOdWvMA3yB8="));
    ...
    private FargateService createFargateService(String id,
        ...
        envVars.put("SPRING_KAFKA_BOOTSTRAP_SERVICES", "localhost.localstack.cloud:4510, localhost.localstack.cloud:4511, localhost.localstack.cloud:4512");
